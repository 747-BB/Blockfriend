...
class OpenseaAPI:
    ...
    def __init__(self, apikey, version = (None, 'v1')):
    ...
    def _make_request(self, endpoint, params, export_file_name, return_response = (None, '', False)):
        ...
        response = requests.get(url, headers, params, **('headers', 'params'))
    ...
    def events(self, asset_contract_address, collection_slug, token_id, account_address, event_type, only_opensea, auction_type, offset, limit, occurred_before, occurred_after, export_file_name = (None, None, None, None, None, False, None, 0, None, None, None, '')):
    ...
    def asset(self, asset_contract_address, token_id, account_address, export_file_name = (None, '')):
    ...
    def assets(self, owner, token_ids, asset_contract_address, asset_contract_addresses, order_by, order_direction, offset, limit, collection, export_file_name = (None, [], None, None, None, None, None, None, None, '')):
    ...
    def collections(self, asset_owner, offset, limit, export_file_name = (None, None, None, '')):
        ...
        return self._make_request('collections', query_params, export_file_name)


    def bundles(self, on_sale, owner, asset_contract_address, asset_contract_addresses, token_ids, limit, export_file_name, offset = (None, None, None, [], [], None, '', None)):
